...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="gvListaDeUsuarios" runat="server" Width="100%" AutoGenerateColumns="False" OnSelectedIndexChanged="gvListaDeUsuarios_SelectedIndexChanged" CssClass="table mt-5" OnRowDeleting="gvListaDeUsuarios_RowDeleting"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="pTipoUser" HeaderText="Tipo Usuario" />
               ...
               <asp:TemplateField>
                       ...
                       <ItemTemplate>
                           <asp:Button ID="btn_EliminarGridView1" ButtonType ="LinkButton" runat="server"
                               Text="Eliminar" class="btn btn-danger" CommandName="Delete"  />
                       </ItemTemplate>
                   </asp:TemplateField>  
